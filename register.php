...
$q="SELECT f_id FROM farmer WHERE f_id='$usn'";
$cq=mysqli_query($conn,$q) or die(mysqli_error($conn));
$ret=mysqli_num_rows($cq);
if($ret==true)
{
echo"<center><h2 style='color:red'>F ID already exists</h2></center>";
}
else
{
$query="INSERT INTO farmer VALUES('$usn','$name','$sem','$age','$addr','$dob')";
...
<tr>
<td><label for="age">FARM ADDRESS:</label></td>
